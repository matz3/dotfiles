...
# Save screenshots to configured folder (e.g. in ~/.localrc)
#defaults write com.apple.screencapture location -string "${DOT_screenshot_dir}"

# Save screenshots in PNG format (other options: BMP, GIF, JPG, PDF, TIFF)
#defaults write com.apple.screencapture type -string "png"

# Enalbe shadow in screenshots
